...
: ${AMENT_CURRENT_PREFIX:="/root/robot_project/install/warehouse_robot_comp219"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/warehouse_robot_comp219/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/warehouse_robot_comp219/environment/path.sh"
